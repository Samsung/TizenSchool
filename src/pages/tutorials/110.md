...
To import project into Visual Studio download and unpack the zip compressed file attached to the tutorial (in this example you can download [ImportingProject.zip](https://s3-us-west-1.amazonaws.com/tizenschool/110/ImportingProject.zip)).
