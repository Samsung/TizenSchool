...
Add this button to the layout developed in [lesson 11](https://samsung.github.io/TizenSchool/tutorial/117/contents/5).
...
Create function for loading and displaying image as it was done in [lesson 16](https://samsung.github.io/TizenSchool/tutorial/117/contents/15). We need to create image object to keep these images and maintain their attributes. Now we can add images to the corresponding objects and put them in _stacklayout_ as its _child_ property.
