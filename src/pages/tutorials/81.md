...
level: 1
state: "open"
thumbnail: "/assets/images/tutorials/81/Data-binding-basic.jpg"
---
...
<img src="/assets/images/tutorials/81/final_rotated.png" style="border-style:solid; border-width:1px; height:600px; width:338px"/>
...
<img src="/assets/images/tutorials/81/diagram1.png" style="height:213px; width:731px"/>
...
<img src="/assets/images/tutorials/81/diagram2.png" style="height:202px; width:897px"/>

## 3. Importing and building solution

Now, we will set up a Visual Studio environment for further development.

Step 1: Download and unpack [BindingTutorial.zip](https://s3-us-west-1.amazonaws.com/tizenschool/81/BindingTutorial_init.zip) \*\*\*\* file.

Step 2: Click File > Open > Project/Solution...

<img src="/assets/images/tutorials/81/open_project.png" style="border-style:solid; border-width:1px; height:400px; width:682px"/>
...
<img src="/assets/images/tutorials/81/open_sln.png" style="border-style:solid; border-width:1px; height:499px; width:958px"/>
...
<img src="/assets/images/tutorials/81/20200219_140322.png" style="border-style:solid; border-width:1px; height:340px; width:316px"/>



Step 4: Build and run application. After right-click on the  **BindingTutorial.Tizen** project, choice a " **set as** **StartUp Project"**

<img src="/assets/images/tutorials/81/20200219_140512.png" style="border-style:solid; border-width:1px; height:608px; width:403px"/>



The application is ready to be launched on the emulator or target device. This is the base version of the application.

<img src="/assets/images/tutorials/81/final_start.png" style="border-style:solid; border-width:1px; height:600px; width:338px"/>
...
<img src="/assets/images/tutorials/81/1.png" style="border-style:solid; border-width:1px; height:600px; width:776px"/>
...
<img src="/assets/images/tutorials/81/without_values_rotated.png" style="border-style:solid; border-width:1px; height:600px; width:338px"/>
...
<img src="/assets/images/tutorials/81/20200219_134235.png" style="border-style:solid; border-width:1px; height:500px; width:720px"/>
...
<img src="/assets/images/tutorials/81/button_work.png" style="border-style:solid; border-width:1px; height:600px; width:776px"/>
