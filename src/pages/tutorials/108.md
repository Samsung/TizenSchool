...
To import the project which will be explained in this tutorial, download the [base code](https://tizenschool.org/assets/images/tutorials/108/MusicPlayer.zip), and refer to this [tutorial](http://tizenschool.org/tutorial/110/contents/1), which will explain how to import project to the Visual Studio.
