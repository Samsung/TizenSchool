...
The starting point is the project available here: [project](https://s3-us-west-1.amazonaws.com/tizenschool/220/GalleryTutorial.zip). Download this package, unzip and launch. You should see the following view:
